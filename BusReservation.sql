...
update BusDetails set NumberOfSeats=31
...
update JourneyRoutes set NumberOfSeats=31
...
sp_helptext proc_addTicketDetails 
...
create proc proc_fetchTicket(@id int)
as
begin
select * from Ticket where BookingUserID
